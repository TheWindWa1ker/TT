...
public:
    ...
    ulong inAttack = 0x0743d330; //[Buttons] in_attack=0x076782c8
    ...
    ulong viewAngle = 0x25b4 - 0x14; //---111  m_ammoPoolCapacity - 0x14
    ...
    ulong localOrigin = 0x0158; //m_localOrigin=0x0158  [DataMap.CBaseViewModel]    -> m_localOrigin
    ulong vecAbsOrigin = 0x014c; //m_vecAbsOrigin=0x014c
    ulong vecAbsVelocity = 0x0140; //[RecvTable.DT_BaseEntity] m_vecAbsVelocity
    ulong bones = 0x0e98 + 0x48; //m_bConstrainBetweenEndpoints=0x0f50 ---111  m_nForceBone + 0x48
    ...
    ulong projectileSpeed = 0x1a70 + 0x04cc; //CWeaponX!m_flProjectileSpeed=0x1f18   111 [WeaponSettingsMeta] base + projectile_launch_speed
    ulong projectileScale = 0x1a70 + 0x04d4; //CWeaponX!m_flProjectileScale=0x1f20 1111 [WeaponSettingsMeta] base + projectile_gravity_scale
    ulong ammoInClip = 0x1638;
